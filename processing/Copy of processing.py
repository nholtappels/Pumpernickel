...
feature_filename = 'features_5_100_10000.csv'
targets_filename = 'targets_5_100_10000.csv'
...
#     features, all_targets, IDs, testfeatures, tt, testIDs = splitdata(features,
#                                                                        all_targets, IDs)
...
#         print '--> predictions: ' + str(predictions) + '\n'
    ...
    for i in range(len(all_predictions)):
        ...
        ID = testIDs[i]
        zeros = [ID] + [0] * 9
        print 'Starting to write predictions to file'
#         zeros = [0.0] * 10
